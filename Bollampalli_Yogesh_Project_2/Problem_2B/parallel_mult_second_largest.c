...
int main(int argc, char* argv[]) {
    ...
    long int gmax1 = -9999999;
    long int gmax2 = -9999999;
    // TODO: Parallelize the matrix-matrix multiplication
#pragma omp parallel for num_threads(thread_count) shared(gmax1, gmax2)
    for (int r1 = 0; r1 < n_row1; r1++) {
        long int lmax1 = -9999999;
        long int lmax2 = -9999999;
